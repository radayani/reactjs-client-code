// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DialogPopVote.js" company="Microsoft">
//     Microsoft Copyright.
// </copyright>
// <summary>
//   The dialog/page component (as per the device size - laptop/phone screen size) to take votes during presenter's mode
// </summary>
// <author>
...
export default class DialogPopVote extends React.Component {
    ...
    handleBroadWinVoteButton() {
        ...
        // }
        // else {
            fetch(`/api/castVote?id=${this.props.presenterSelectedProjId}&alias=${this.state.voterAlias.toLowerCase()}&pin=${this.state.voterPin}`, {
    ...
    handleNarrowWinVoteButton() {
        ...
        if (!this.state.voterPin || !this.state.voterAlias) {
            ...
            fetch(`/api/castVote?id=${this.props.match.params.projId}&alias=${this.state.voterAlias.toLowerCase()}&pin=${this.state.voterPin}`, {
